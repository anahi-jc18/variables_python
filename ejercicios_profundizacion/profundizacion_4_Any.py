...
print("Ingrese el nombre de su madre")
name_mum = str(input())

print("Ingrese el apellido de su madre")
surname_mum = str(input())

print("Ingrese el nombre de su padre")
name_fa = str(input())

print("Ingrese el apellido de su padre")
surname_fa = str(input())

print("Ingrese su nombre")
name = str(input())

print("Su apellido es:", name.capitalize(), surname_fa.capitalize(), surname_mum.capitalize())



#Respuesta segun el enunciado:

print("Ingrese el nombre completo de su madre")
name_mother = str(input())

print("Ingrese el nombre completo de su padre")
name_father = str(input())

print("Ingrese su nombre")
name_son = str(input())

print("Su nombre completo es:",name_son, name_father.split(' ')[1],name_mother.split(' ')[1])
